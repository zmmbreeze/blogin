...
(function() {
  var copy, dir, fs, getFileName, markdown, mkdir, moment, path, read, readJSON, write;
  ...
  exports.pathToTitle = function(filePath) {
    ...
    fileName = fileName.replace(/([^\\])\-/g, '$1 ').replace(/\\-/g, '-');
  ...
  exports.readMdToHtml = function(filePath) {
    var file;
    return file = markdown.toHTML(read(filePath));
  };
